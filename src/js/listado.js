...
Listado.prototype.obtC = function() {
  ...
  //   }
  var c = [];
  c = this.restaurantes.map(function(restaurantes) {
...
Listado.prototype.obtR = function() {
  ...
  //   }
  var r = [];
  r = this.restaurantes.map(function(restaurantes) {
...
Listado.prototype.obtH = function() {
  ...
  //   }
  var arregloH = [];
  arregloH = this.restaurantes.map(function(restaurantes) {
...
Listado.prototype.obtenerRestaurantes = function(
  filtroRubro,
  filtroCiudad,
  filtroHorario
) {
